      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2 tracking-tight">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3 tracking-tight">
            ...
            <p className="text-gray-700 leading-relaxed mt-4 p-4 bg-blue-50 rounded-lg border-l-4 border-blue-500 font-semibold">
