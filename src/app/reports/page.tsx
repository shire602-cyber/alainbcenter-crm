              ...
              <>
                ...
                >
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">New Leads</p>
                      <p className="text-2xl font-semibold tracking-tight">{kpis.activity.recentLeads30Days}</p>
              </div>
                    <div>
                      <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">Won Deals</p>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                      <div>
                        ...
                        <p className="text-xl font-semibold tracking-tight">{user.metrics.conversionRate.toFixed(1)}%</p>
                      ...
                      <div>
                        <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">Tasks Completed</p>
                        <p className="text-xl font-semibold tracking-tight">{user.metrics.completedTasks}</p>
                        <p className="text-xs text-slate-500 dark:text-slate-500 mt-0.5">
                          {user.metrics.taskCompletionRate.toFixed(1)}% rate
                        </p>
                      </div>
                      <div>
                        <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">Messages Sent</p>
                        <p className="text-xl font-semibold tracking-tight">{user.metrics.messagesSent30Days}</p>
                        <p className="text-xs text-slate-500 dark:text-slate-500 mt-0.5">last 30 days</p>
                      </div>
                    </div>
                    <div className="mt-3 pt-3 border-t border-slate-200 dark:border-slate-800">
                      <div className="flex items-center gap-3 text-xs">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="font-medium text-slate-900 dark:text-slate-100">{user.metrics.inProgressLeads}</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="font-medium text-slate-900 dark:text-slate-100">{user.metrics.recentActivity30Days}</span>
                        </div>
                      </div>
              </div>
                  </BentoCard>
                  ...
                  {kpis.serviceTypes.map((service) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Badge variant={service.conversionRate >= 20 ? 'default' : 'secondary'} className="text-xs">
                ...
                <div className="space-y-2">
                  {kpis.channels.map((channel) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <div>
                          <h3 className="text-sm font-semibold capitalize">{channel.channel}</h3>
                          <p className="text-xs text-slate-600 dark:text-slate-400 mt-0.5">
                            {channel.total} leads • {channel.won} won
                          </p>
                        </div>
                        <Badge variant={channel.conversionRate >= 20 ? 'default' : 'secondary'} className="text-xs">
