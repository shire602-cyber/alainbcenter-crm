      ...
      if (event.eventType === 'leadgen' && payload.object === 'page') {
        ...
        try {
          await processLeadgenEvent({
            payload: {
              leadgenId: event.leadgenId || event.rawPayload?.leadgen_id || '',
              formId: event.formId || event.rawPayload?.form_id || null,
              adId: event.adId || event.rawPayload?.ad_id || null,
              pageId: event.pageId || pageId || null,
              createdTime: event.createdTime || event.rawPayload?.created_time || null,
            },
